...
inline std::ostream& operator<<(std::ostream& os, Plane value) noexcept
{
    // clang-format off
    switch (value)
    {
...
inline std::ostream& operator<<(std::ostream& os, Age value) noexcept
{
    // clang-format off
    switch (value)
    {
    ...
    case Age::V15_1: return os << "V15_1";
    case Age::V16_0: return os << "V16_0";
...
inline std::ostream& operator<<(std::ostream& os, Bidi_Class value) noexcept
{
    // clang-format off
    switch (value)
    {
...
inline std::ostream& operator<<(std::ostream& os, Bidi_Paired_Bracket_Type value) noexcept
{
    // clang-format off
    switch (value)
    {
...
inline std::ostream& operator<<(std::ostream& os, Canonical_Combining_Class value) noexcept
{
    // clang-format off
    switch (value)
    {
...
inline std::ostream& operator<<(std::ostream& os, Decomposition_Type value) noexcept
{
    // clang-format off
    switch (value)
    {
...
inline std::ostream& operator<<(std::ostream& os, East_Asian_Width value) noexcept
{
    // clang-format off
    switch (value)
    {
...
inline std::ostream& operator<<(std::ostream& os, Grapheme_Cluster_Break value) noexcept
{
    // clang-format off
    switch (value)
    {
    case Grapheme_Cluster_Break::Undefined: return os << "Undefined";
    case Grapheme_Cluster_Break::CR: return os << "CR";
    case Grapheme_Cluster_Break::Control: return os << "Control";
    case Grapheme_Cluster_Break::E_Base: return os << "E_Base";
    case Grapheme_Cluster_Break::E_Base_GAZ: return os << "E_Base_GAZ";
    case Grapheme_Cluster_Break::E_Modifier: return os << "E_Modifier";
    case Grapheme_Cluster_Break::Extend: return os << "Extend";
    case Grapheme_Cluster_Break::Glue_After_Zwj: return os << "Glue_After_Zwj";
    ...
    case Grapheme_Cluster_Break::Other: return os << "Other";
...
inline std::ostream& operator<<(std::ostream& os, Hangul_Syllable_Type value) noexcept
{
    // clang-format off
    switch (value)
    {
...
inline std::ostream& operator<<(std::ostream& os, Indic_Conjunct_Break value) noexcept
{
    // clang-format off
    switch (value)
    {
    case Indic_Conjunct_Break::Consonant: return os << "Consonant";
    case Indic_Conjunct_Break::Extend: return os << "Extend";
    case Indic_Conjunct_Break::Linker: return os << "Linker";
    case Indic_Conjunct_Break::None: return os << "None";
    }
    // clang-format on
    return os << "(" << static_cast<unsigned>(value) << ")";
}

inline std::ostream& operator<<(std::ostream& os, Indic_Positional_Category value) noexcept
{
    // clang-format off
    switch (value)
    {
...
inline std::ostream& operator<<(std::ostream& os, Indic_Syllabic_Category value) noexcept
{
    // clang-format off
    switch (value)
    {
    ...
    case Indic_Syllabic_Category::Reordering_Killer: return os << "Reordering_Killer";
...
inline std::ostream& operator<<(std::ostream& os, Jamo_Short_Name value) noexcept
{
    // clang-format off
    switch (value)
    {
...
inline std::ostream& operator<<(std::ostream& os, Joining_Group value) noexcept
{
    // clang-format off
    switch (value)
    {
    ...
    case Joining_Group::Kashmiri_Yeh: return os << "Kashmiri_Yeh";
    ...
    case Joining_Group::Teh_Marbuta_Goal: return os << "Teh_Marbuta_Goal";
...
inline std::ostream& operator<<(std::ostream& os, Joining_Type value) noexcept
{
    // clang-format off
    switch (value)
    {
...
inline std::ostream& operator<<(std::ostream& os, Line_Break value) noexcept
{
    // clang-format off
    switch (value)
    {
    case Line_Break::Aksara: return os << "Aksara";
    case Line_Break::Aksara_Prebase: return os << "Aksara_Prebase";
    case Line_Break::Aksara_Start: return os << "Aksara_Start";
    ...
    case Line_Break::Virama: return os << "Virama";
    case Line_Break::Virama_Final: return os << "Virama_Final";
...
inline std::ostream& operator<<(std::ostream& os, NFC_Quick_Check value) noexcept
{
    // clang-format off
    switch (value)
    {
...
inline std::ostream& operator<<(std::ostream& os, NFKC_Quick_Check value) noexcept
{
    // clang-format off
    switch (value)
    {
...
inline std::ostream& operator<<(std::ostream& os, Numeric_Type value) noexcept
{
    // clang-format off
    switch (value)
    {
...
inline std::ostream& operator<<(std::ostream& os, Sentence_Break value) noexcept
{
    // clang-format off
    switch (value)
    {
...
inline std::ostream& operator<<(std::ostream& os, Vertical_Orientation value) noexcept
{
    // clang-format off
    switch (value)
    {
...
inline std::ostream& operator<<(std::ostream& os, Word_Break value) noexcept
{
    // clang-format off
    switch (value)
    {
...
inline std::ostream& operator<<(std::ostream& os, Core_Property value) noexcept
{
    // clang-format off
    switch (value)
    {
...
inline std::ostream& operator<<(std::ostream& os, General_Category value) noexcept
{
    // clang-format off
    switch (value)
    {
...
inline std::ostream& operator<<(std::ostream& os, Script value) noexcept
{
    // clang-format off
    switch (value)
    {
    ...
    case Script::Garay: return os << "Garay";
    ...
    case Script::Gurung_Khema: return os << "Gurung_Khema";
    ...
    case Script::Kirat_Rai: return os << "Kirat_Rai";
    ...
    case Script::Ol_Onal: return os << "Ol_Onal";
    ...
    case Script::Sunuwar: return os << "Sunuwar";
    ...
    case Script::Todhri: return os << "Todhri";
    case Script::Toto: return os << "Toto";
    case Script::Tulu_Tigalari: return os << "Tulu_Tigalari";
...
inline std::ostream& operator<<(std::ostream& os, Block value) noexcept
{
    // clang-format off
    switch (value)
    {
    ...
    case Block::CJK_Unified_Ideographs_Extension_I: return os << "CJK_Unified_Ideographs_Extension_I";
    ...
    case Block::Egyptian_Hieroglyphs_Extended_A: return os << "Egyptian_Hieroglyphs_Extended_A";
    ...
    case Block::Garay: return os << "Garay";
    ...
    case Block::Gurung_Khema: return os << "Gurung_Khema";
    ...
    case Block::Kirat_Rai: return os << "Kirat_Rai";
    ...
    case Block::Myanmar_Extended_C: return os << "Myanmar_Extended_C";
    ...
    case Block::Ol_Onal: return os << "Ol_Onal";
    ...
    case Block::Sunuwar: return os << "Sunuwar";
    ...
    case Block::Symbols_for_Legacy_Computing_Supplement: return os << "Symbols_for_Legacy_Computing_Supplement";
...
inline std::ostream& operator<<(std::ostream& os, EastAsianWidth value) noexcept
{
    // clang-format off
    switch (value)
    {
